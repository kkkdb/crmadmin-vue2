<template>
	<div class='point-exchange-setting pd-lr-20'>
		...
		<el-dialog :title="dialogType=='add'?'新增礼品':'编辑礼品'" :visible.sync="dialogFormVisible">
		  	<el-form :model="dialogForm" :inline="true" label-width='100px'>
		    	...
		    	<el-form-item label="兑换积分数">
		      		<el-input v-model="dialogForm.point" auto-complete="off" style='width: 220px;'></el-input>
	    		</el-form-item>
	...
	export default{
		mounted() {
			let list = [{
				...
				imgUrl: 'http://leqeeweishop.oss-cn-hangzhou.aliyuncs.com/shipping/2.jpg', //图片地址
				inID: '2', //内部ID
				outID: '22222', //外部ID
				giftName: '礼品二号', //礼品名称
				exchangeType: '快递寄送', //领取方式
		...
		data() {
			return{
				navList: [{name: '会员中心'},{name: '兑礼及试用'},{name: '积分兑礼设置'}],
				tableData: [],
