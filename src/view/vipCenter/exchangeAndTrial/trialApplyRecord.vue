<template>
	<div class='point-exchange-record pd-lr-20'>
		...
		<div class="form-content">
			<el-form :model="recordForm" ref="recordForm" :inline="true" label-width="100px">
				<el-row>
					<el-col :span='5'>
				...
				<el-row>
					<el-col :span='5'>
						<el-form-item label='试用产品消息'>
							<el-input v-model='recordForm.giftInfo' placeholder='礼品名称/内部ID/外部ID' style='width: 220px;'></el-input>
						</el-form-item>
					</el-col>
					<el-col :span='5'>
						<el-form-item label='试用方式'>
							<el-select v-model='recordForm.trialType'>
								<el-option label='免费使用' value='freeTrial'></el-option>
								<el-option label='积分兑换' value='pointChange'></el-option>
								<el-option label='付邮试用' value='postTrial'></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span='5'>
		...
		<div class="table-content">
			<el-table :data='tableData' style='width: 100%;font-size: 12px;' @selection-change="handleSelectionChange">
				...
				<el-table-column label="试用类型" prop='trialType'></el-table-column>
...
<script>
	...
	export default{
		...
		data() {
			return{
				navList: [{name: '会员中心'},{name: '兑礼及试用'},{name: '试用申请记录'}],
				recordForm: {
					exchangeType: 'shipping', 	//领取方式
					trialType: 'freeTrial', 	//试用类型
					counterId: '', 				//柜台id
					date: '', 					//日期
					orderStatus: '', 			//订单状态
